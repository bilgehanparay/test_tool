...
// configuration step. It creates a namespace called `test_tool`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", test_tool::cmake::project_name, test_tool::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", test_tool::cmake::project_version);
      return EXIT_SUCCESS;
    }
